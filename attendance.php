    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <div class="d-flex justify-content-between">
                <h1>Attendance for <?=$_SESSION['firstname']?></h1>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card Last-Attended overflow-auto">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">My Attendance Record<span></span></h5>
                            ...
                            <table class="table table-borderless datatable">
                                ...
                                <tbody>
                                    <?php
                                    $sql = mysqli_query($connection, "SELECT events.*,attendance.*
                                        FROM attendance
                                        JOIN events ON attendance.eventid = events.id where userid={$_SESSION['userid']} ");
                                    $n = 1;
                                    while ($row = mysqli_fetch_assoc($sql)) {
                                    ?>
                                        <tr>
                                            ...
                                            <th><?php echo $row['starttime'] ?> - <?php echo $row['endtime'] ?></th>
