    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <div class="d-flex justify-content-between">
                <h1>Pastors</h1>
                <a href="members.php" class="btn btn-primary"> <i class="bi bi-plus-square"></i> Add Pastors</a>
            </div>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Pastors</a></li>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card Last-Attended overflow-auto">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">All Pastors<span></span></h5>
                            ...
                            <table class="table table-borderless datatable">
                                ...
                                <tbody>
                                    <?php 
                                        $sql = mysqli_query($connection, "SELECT * FROM users where membership='pastor' order by id DESC");
                                        $n = 1;
